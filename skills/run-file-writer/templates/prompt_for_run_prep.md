...
- templates/specs.md
- templates/prompt_for_supervisor.md
- templates/prompt_for_supervisor_goal.md
...
The script copies every missing executor run file and leaves existing executor files unchanged. It always rebuilds `workflow_<workflow id>/prompt_for_supervisor.md` and `workflow_<workflow id>/prompt_for_supervisor_goal.md` from templates. After that, edit the copied or rebuilt files in place. Do not recreate templated run files from memory. Preserve template headings unless a heading conflicts with the task, `control/constraint.md`, or the heading risk checks below.
