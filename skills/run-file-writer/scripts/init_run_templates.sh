...
copy_always prompt_for_supervisor.md "$workflow_dir/prompt_for_supervisor.md"
copy_always prompt_for_supervisor_goal.md "$workflow_dir/prompt_for_supervisor_goal.md"
